                ...
                <div class="row">
                        ...
                        <div class="modal fade" id="m1">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">Landscape 1</div>
                                    <div class="modal-body">
                                        <img src="image/pic1.jpg" class="img-thumbnail">
                                    </div>
                                    <div class="modal-footer">Landscape view 1</div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="modal fade" id="m2">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">Landscape 2</div>
                                    <div class="modal-body">
                                        <img src="image/pic2.jpg" class="img-thumbnail">
                                    </div>
                                    <div class="modal-footer">Landscape view 2</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        ...
                        <div class="modal fade" id="m3">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">Landscape 3</div>
                                    <div class="modal-body">
                                        <img src="image/pic3.jpg" class="img-thumbnail">
                                    </div>
                                    <div class="modal-footer">Landscape view 3</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        ...
                        <div class="modal fade" id="m4">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">Landscape 4</div>
                                    <div class="modal-body">
                                        <img src="image/pic4.jpg" class="img-thumbnail">
                                    </div>
                                    <div class="modal-footer">Landscape view 4</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        ...
                        <div class="modal fade" id="m5">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">Landscape 5</div>
                                    <div class="modal-body">
                                        <img src="image/pic5.jpg" class="img-thumbnail">
                                    </div>
                                    <div class="modal-footer">Landscape view 5</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        ...
                        <div class="modal fade" id="m6">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">Landscape 6</div>
                                    <div class="modal-body">
                                        <img src="image/pic6.jpg" class="img-thumbnail">
                                    </div>
                                    <div class="modal-footer">Landscape view 6</div>
                                </div>
                            </div>
                        </div>
                    </div>
